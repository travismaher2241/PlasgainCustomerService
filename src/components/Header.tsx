  ...
  return (
    <header className="h-13.5 bg-surface border-b border-line px-4 sm:px-6.5 flex items-center gap-4 shrink-0 sticky top-0 z-30">
      <button
        ...
        className="md:hidden p-2 -ml-2 text-body-dim hover:text-body rounded-edge hover:bg-paper cursor-pointer"
        title="Open menu"
      >
      ...
      {/* Breadcrumb */}
      <div className="flex items-center gap-1.5 text-meta text-body-dim truncate min-w-0">
        <span className="font-semibold text-body">{getTabDisplayName(activeTab)}</span>
        <span className="text-body-faint px-1">/</span>
      ...
      <div className="flex items-center gap-2 shrink-0 ml-auto">
        ...
        <button
          ...
          className="flex items-center gap-2 text-meta text-body-faint bg-paper hover:bg-raised px-2.5 py-1.5 rounded-edge border border-line hover:border-line-strong transition-colors cursor-pointer"
        >
          <Search className="w-3.5 h-3.5" />
          <span className="hidden sm:inline">Search specs &amp; docs</span>
          <kbd className="u-data hidden sm:inline-block ml-1 px-1 text-[0.625rem] text-body-faint border border-line-strong rounded-[2px]">
            ⌘K
          </kbd>
        </button>
        ...
        <button
          ...
          className="hidden sm:flex items-center gap-1.5 text-meta font-medium text-body-dim hover:text-body px-2.5 py-1.5 rounded-edge border border-line hover:border-line-strong transition-colors cursor-pointer"
